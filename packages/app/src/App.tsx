...
const customTheme = createUnifiedTheme({
  palette: {
    ...
    navigation: {
      ...
      indicator: '#1c79b8d2',
      color: '#2c3e50',
      selectedColor: '#6d46b4ff',
    },
  },
  // --- ADICIONE ESTA PARTE PARA O HEADER AZUL ---
  defaultPageTheme: 'home',
  pageTheme: {
    home: genPageTheme({ colors: ['#d41860ff', '#3498db'], shape: shapes.wave }),
    documentation: genPageTheme({ colors: ['#d41860ff', '#3498db'], shape: shapes.wave }),
    tool: genPageTheme({ colors: ['#3498db', '#3498db'], shape: shapes.round }),
    service: genPageTheme({ colors: ['#d41860ff', '#3498db'], shape: shapes.wave }),
    website: genPageTheme({ colors: ['#d41860ff', '#3498db'], shape: shapes.wave }),
    library: genPageTheme({ colors: ['#d41860ff', '#3498db'], shape: shapes.wave }),
